...
const Navbar = () => {
  return (
    <nav
      className="flex justify-between items-center  py-3 border-none lg:border px-2 fixed top-0 left-0 right-0 bg-[#f5f5f5ff]
    z-20"
    >
      {/* 1st Div */}
      <div className="flex flex-col lg:flex-row justify-between items-center mx-auto lg:mx-0"></div>
      ...
      <div className="hidden lg:block ">
        <input
          ...
          className="py-2 rounded-full w-[40vw] 
    outline-none text-center border text-black"
        />
      </div>
      ...
      <div className="hidden lg:flex justify-between items-center gap-4">
        <div className="flex justify-center gap-2">
          <div className="flex flex-col text-sm">
            <span className="text-[14px] txt-gray-600 font-semibold">
              Music Languages
            </span>
